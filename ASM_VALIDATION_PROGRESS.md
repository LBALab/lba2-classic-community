...
| [~] | `pol_work/POLYTZG.ASM` | `pol_work/POLYTZG.CPP` | Filler_TextureZGouraud, ... (6 fillers) | TextureZ + Gouraud variants | CPP tested via Fill_Poly (3 tests inc. random). ASM blocked: `Fill_Init_Perspective` is DWORD (func ptr) in ASM but function in CPP — symbol type mismatch. |
