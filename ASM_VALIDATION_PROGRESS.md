...
| Status | ASM File | CPP File | Function(s) | Description | Notes |
|--------|----------|----------|-------------|-------------|-------|
| [x] | `pol_work/POLY.ASM` | `pol_work/POLY.CPP` | INV64, SetFog, SetCLUT, Switch_Fillers, Fill_Poly, Fill_PolyClip, Triangle_ReadNextEdge, SetScreenPitch | Core polygon rendering pipeline | **ASM equiv** — 21 tests (13 CPP + 4 ASM-vs-CPP: INV64 300 rounds, SetFog 300 rounds, SetCLUT 300 rounds, Switch_Fillers 300 rounds; + Fill_PolyClip 300 rounds [~known discrepancy: ASM hardcodes ZBuf slope tables, CPP uses non-ZBuf], Fill_Sphere 300 rounds, Line_A 300 rounds). Fill_PolyFast cannot be tested directly (Watcom jmp-table dispatch to C-convention Jmp_Solid). Triangle_ReadNextEdge tested indirectly through Fill_PolyClip filler tail-call chain. |
