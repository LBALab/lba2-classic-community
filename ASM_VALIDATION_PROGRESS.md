...
| [x] | `pol_work/POLYTZF.ASM` | `pol_work/POLYTZF.CPP` | Filler_TextureZFogSmooth, ... (3 fillers) | TextureZ + smooth fog variants | **ASM equiv** — 3 CPP + 2 ASM strict tests (static + 30 random). **FIXED**: rewrote CPP from affine to perspective-correct with inline x87 asm, fog CLUT, ZBuf perspective correction. Fixed sub-pixel correction accumulation bug. |
