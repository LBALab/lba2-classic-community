...
| [x] | `SVGA/MASK.ASM` | `SVGA/MASK.CPP` | `AffMask` | Display mask/sprite with transparency | ASM ≡ CPP: full-framebuffer + ScreenX/Y bounds equivalence over fixed solid/pattern/sparse banks, screen-edge and clip-window clipping, off-screen no-op cases, and 100 deterministic random rounds via Watcom ABI wrapper |
