...
| [ARCH_RULES_PLAN.md](plan/ARCH_RULES_PLAN.md) | Proposed | Checking the boundaries the docs already state: seven rules from CODESTYLE and AGENTS.md, each measured against the tree, plus the four candidates deliberately left out. Companion to [REFACTOR_ROADMAP.md](plan/REFACTOR_ROADMAP.md). |
