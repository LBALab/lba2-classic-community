...
[^coverage-pr]: Pull request 659 on origin, the paragraph beginning "A `mode differs` mismatch may be a sibling defect"; SOURCES/RECORD.CPP, `replay_covered_the_file` and the comment above it.
