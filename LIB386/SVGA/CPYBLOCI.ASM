...
fmt_copybloc_1	DB	"[ASM][CopyBlockIncrust][1] x0=%d y0=%d x1=%d y1=%d src=%p xd=%d yd=%d dst=%p", 10, 0
...
CopyBlockIncrust	proc uses ebp,\
		...
		; --- debug trace [ASM][CopyBlockIncrust][1] params ---
		pushad
		push	dst
		push	yd
		push	xd
