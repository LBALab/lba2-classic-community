...
- Replaying a recorded session stopped on the save-name screen and never went
  ...
  else now, so a session that saves under a name replays as one. The cheat codes
  typed at the pause menu came off the same reader and were equally out of reach;
  they work in a replay too.
