#!/usr/bin/env bash
# The five volume keys survive a boot, and an out-of-range one is brought into
# range rather than passed through.
#
...
for pair in "WaveVolume 33" "VoiceVolume 44" "MusicVolume 55" "MasterVolume 66" "ReverseStereo 1"; do
    set -- $pair
...
for key in WaveVolume VoiceVolume MusicVolume MasterVolume; do
...
pass "the five volume keys round-trip, and out-of-range values are clamped"
